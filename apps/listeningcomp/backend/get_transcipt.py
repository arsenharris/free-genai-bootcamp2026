...
class YouTubeTranscriptDownloader:
    ...
    # Initialise the downloader with a list of lanugages you want to pull tracsript for
    def __init__(self, languages: List[str] = ["es", "en"]):
        self.languages = languages


    #  Extract 11-character Youtube video ID from YouTube URL
    ...
    #Downloads the transctipt for a given video ID, and returns it as a list of dictionaries, where each dictionary contains the text and timing information for a segment of the transcript.
    ...
    #Saves the downloaded transcript to a text file, where each line corresponds to a segment of the transcript. The filename is derived from the video ID or a provided name, and the file is saved in a "transcripts" directory.
